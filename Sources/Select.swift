...
public func select(readFds: Set<FileDescriptor> = [], writeFds: Set<FileDescriptor> = [], errorFds: Set<FileDescriptor> = [], timeout: Float? = nil) throws -> (Set<FileDescriptor>, Set<FileDescriptor>, Set<FileDescriptor>) {
    var nfds: Int32 = 0
    var readfds = fd_set()
    var writefds = fd_set()
    var errorfds = fd_set()
